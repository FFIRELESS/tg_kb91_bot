...
export const textController = {
    ...
    botInfo: async (msg) => {
        ...
        await msg.replyWithMarkdown("***kBOT-91*** – бот, створений для облегшення й так тяжкого життя групи"
            ...
            + "___!gpt {ваше повідомлення}___ – поговорити з GPT-3;\n___!gpt3 {ваше повідомлення}___ – поговорити з "
            + "GPT-3.5 Turbo (ChatGPT);\n___!gpt4 {ваше повідомлення}___ – поговорити з GPT-4 (ChatGPT Plus);"
            + "\n___!img {ключові слова}___ – згенерувати зображення з DALL•E•2.\n\n"
